  ...
  return (
    <div className='mx-5 my-10 bg-white shadow-md px-5 rounded-xl'>
        ...
        <div className='flex justify-between mt-10'>
            <button
                type='button'
                className='py-2 px-10 mb-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold uppercase rounded-lg '
                onClick={() => setPaciente(paciente)}
            >Editar</button>
            <button
                type='button'
                className='py-2 px-10 mb-2 bg-red-600 hover:bg-red-700 text-white font-bold uppercase rounded-lg '
